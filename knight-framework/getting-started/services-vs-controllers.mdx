---
title: "Services vs Controllers"
description: "In the Knight Framework, the architecture is centered around Services. These are modules that encapsulate your game’s business logic, game state, and communication between the client and server.
...
| **Concept**    | **Definition**                                             |
| -------------- | ---------------------------------------------------------- |
| Service        | _A module that runs logic in the Knight Framework._        |
| Controller     | _A naming convention for client-side services._            |
| Shared Service | _A deterministic module usable by both client and server._ |
